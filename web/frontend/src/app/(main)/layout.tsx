  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        <Topbar />
        <main className={`min-h-0 flex-1 ${doctorChat ? 'overflow-hidden' : 'overflow-y-auto p-6'}`}>{children}</main>
        {!doctorChat && <footer className="shrink-0 border-t border-gray-200 bg-white px-6 py-2.5 text-xs text-gray-400 text-center">
